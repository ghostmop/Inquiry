location_4_description = "You are standing outside of MUSC. You see The Starbucks is to your right, Mills library is behind you, and MDCL lies to the left."
...
No_pedestrians_sign = "Description of object 2"
...
while location == 4:
	...
	if user_input == "look":
		print location_4_description
	elif user_input == "look willy dog" or user_input == "look willy":
		print Willy_Dog
		...
		if hotdog_choice == "Yes" or hotdog_choice == "yes":
			print "You suddenly remember that you're vegetarian and get a little bummed out."
		elif hotdog_choice == "No" or hotdog_choice == "no":
